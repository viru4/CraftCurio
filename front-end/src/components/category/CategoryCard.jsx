...
const CategoryCard = ({ category, isSelected, onClick, className = "" }) => {
  ...
  const getCategoryBackgroundImage = (categoryName) => {
    const imageMap = {
      ...
      "Handloom Sarees and Textiles": handcraftedGoods,
      "Terracotta Pottery and Sculpture": pottery1,
      "Traditional Jewelry and Ornaments": traditionalBowls,
      "Woodcarving and Furniture": woodworking,
      "Metalwork and Brass Items": stoneWork,
      "Glasswork and Crystal Items": ceramicDishes,
      "Leatherwork and Bags": handcraftedGoods,
      "Stone Carving and Sculpture": stoneWork,
      "Bamboo and Cane Work": woodworking,
      "Embroidery and Needlework": handcraftedGoods,
      "Carpet and Rug Weaving": traditionalBowls,
      "Ceramic and Porcelain": pottery1,
      "Traditional Paintings and Art": ceramicDishes,
      "Lacquerware and Painted Items": pottery,
      "Paper Crafts and Calligraphy": handcraftedGoods,
      "Tribal Art and Crafts": stoneWork,
      "Musical Instruments": woodworking,
      "Traditional Toys and Games": traditionalBowls,
      "Home Decor and Furnishings": pottery1,
      "Spiritual and Religious Items": ceramicDishes,
      "Pottery": pottery1,
      "Textiles": handcraftedGoods,
      "Woodwork": woodworking,
      "Metalwork": stoneWork,
      "Glasswork": ceramicDishes,
      "Leatherwork": traditionalBowls,
